...
section[data-testid="stSidebar"] {
    ...
    box-shadow: 10px 0 30px rgba(31, 38, 135, 0.05) !important;
...
.sidebar-title-container {
    ...
    border-radius: var(--radius-md);
    box-shadow: 0 8px 32px rgba(31, 38, 135, 0.07), inset 0 2px 3px rgba(255,255,255,1);
...
.sidebar-title-container:hover {
    ...
    box-shadow: 0 12px 40px rgba(31, 38, 135, 0.1), inset 0 2px 3px rgba(255,255,255,1);
}
...
with st.sidebar:
    st.markdown(
        ...
        <div class="sidebar-title-container">
            ...
            <div class="sidebar-subtitle">v1.0 &middot; KNN Classifier</div>
        </div>
        """,
